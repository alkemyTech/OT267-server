    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          1- Encuentro semanal con tutores (Individuales y grupales)
          2- Actividad proyecto (los participantes del programa deben pensar una
          actividad relacionada a lo que quieren hacer una vez terminada la
          escuela y su tutor los acompaña en el proceso)
          3- Ayudantías (los que comienzan el 2do años del programa deben
          ...
          espera).
          4- Acompañamiento escolar y familiar (Los tutores son encargados de
          articular con la familia y con las escuelas de los jóvenes para
          monitorear el estado de los tutorados)
          5- Beca estímulo (los jóvenes reciben una beca estímulo que es
          supervisada por los tutores). Actualmente se encuentran inscriptos en
          el programa 30 adolescentes.
          6- Taller Arte y Cuentos: Taller literario y de manualidades que se realiza
          semanalmente.
          7- Paseos recreativos y educativos: Estos paseos están pensados para
